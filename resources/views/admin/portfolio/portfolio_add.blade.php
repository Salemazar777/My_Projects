    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header align-items-center d-flex">
                <h4 class="card-title mb-0 flex-grow-1">Portfolio Page</h4>  
            </div><!-- end card header -->
            <div class="card-body">
             <form method="POST" action="{{route('store.portfolio')}}" enctype="multipart/form-data">
              ...
              <div class="live-preview">            
                 ...
                 <input type="text" name="portfolio_name" class="form-control" id="title">
            ...
            <div class=" col-md-12">
                    ...
                    <input type="text" name="portfolio_title" class="form-control" id="short_title">
            ...
            <div class=" col-md-12">
                ...
                <textarea  id="elm1"  name="portfolio_description" class="form-control" rows="5"></textarea><br/>
