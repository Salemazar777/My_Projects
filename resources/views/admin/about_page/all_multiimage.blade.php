                ...
                <div class="row">
                    ...
                    <thead>
                        <tr role="row">
                            ...
                            <th class="sorting" tabindex="0" aria-controls="selection-datatable" rowspan="1" colspan="1" style="width: 222px;" aria-label="Position: activate to sort column ascending">About Multi Image</th>

                            <th class="sorting" tabindex="0" aria-controls="selection-datatable" rowspan="1" colspan="1" style="width: 104px;" aria-label="Office: activate to sort column ascending">Action</th>
                        </tr>
                    </thead>
                    <tbody>
                        @php($i = 1)
                        ...
                        <tr class="even">
                            ...
                            <td><img height="50px;" width="50px;" src="{{asset('image/multi/'.$image->multi_image)}}" /></td>
                            <td><a class="btn btn-info sm" href="{{route('edit.multi.image',$image->id)}}"><i class="fas fa-edit"></i>Edit</a>/<a class="btn btn-danger sm" href="{{route('delete.multi.image',$image->id)}}">Delete</a></td>
                        </tr>
                        @endforeach
                    </tbody>
                </table>
