    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header align-items-center d-flex">
                <h4 class="card-title mb-0 flex-grow-1">Update Multi Image</h4>  
            </div><!-- end card header -->
            <div class="card-body">
            ...
            <div class="col-md-12" style="margin: 20px 0px;">
              ...
              <div style="margin-bottom:20px;" class="mt-4 mt-md-0 ">
                  <img class="rounded  avatar-xl" id="showimage" alt="200x200" src="{{asset('image/multi/'.$multi_image->multi_image)}}" data-holder-rendered="true">
              </div>
