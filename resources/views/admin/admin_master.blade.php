...
<!-- Mirrored from themesbrand.com/velzon/html/default/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 07 Mar 2022 14:42:56 GMT -->
<head>
    ...
    <link href="{{asset('admin/assets/libs/select2/css/select2.min.css')}}" rel="stylesheet" type="text/css">
     ...
     <link rel="stylesheet" type="text/css" href="{{asset('admin/assets/engine1/style.css')}}" />
     <script type="text/javascript" src="{{asset('admin/assets/engine1/jquery.js')}}"></script>
     <!-- End WOWSlider.com HEAD section -->
   

    <link href="{{asset('admin/assets/js/toastify.min.css')}}" rel="stylesheet" type="text/css">
    ...
    <script src="{{asset('admin/assets/js/app.js')}}"></script>
     ...
     <script src="{{asset('admin/assets/js/pages/form-editor.init.js')}}"></script>
      ...
      <!-- Required datatable js -->
        ...
        <script src="{{asset('admin/assets/js/notify.min.js')}}"></script>
...
<!-- Mirrored from themesbrand.com/velzon/html/default/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 07 Mar 2022 14:46:19 GMT -->
</html>