...
<div class="card">
<div class="card-body">
    <a href="{{route('stock.report.pdf')}}" target="_blank" class="btn btn-success w-lg waves-effect waves-light" style="float: right" ><i class="ri-printer-fill">Stock Report Print</i></a><br/><br/>
